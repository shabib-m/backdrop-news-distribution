Backdrop.locale = { 'pluralFormula': function ($n) { return Number((($n==1)?(0):(($n==0)?(1):(($n==2)?(2):(((($n%100)>=3)&&(($n%100)<=10))?(3):(((($n%100)>=11)&&(($n%100)<=99))?(4):5)))))); }, 'strings': {"":{"More":"\u0627\u0644\u0645\u0632\u064a\u062f","Show":"\u0639\u0631\u0636","Hide":"\u0625\u062e\u0641\u0627\u0621"}} };;
(function ($) {

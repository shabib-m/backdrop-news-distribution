...
<div class="layout--boxton <?php print implode(' ', $classes); ?>"<?php print backdrop_attributes($attributes); ?>>
  ...
  <?php if ($content['header']): ?>
    <header class="navbar bg-base-100 shadow-lg px-4 lg:px-12 sticky top-0 z-40 min-h-[64px]" role="banner" aria-label="<?php print t('Site header'); ?>">
      <div class="l-header-inner w-full flex flex-col md:flex-row items-center justify-between gap-4 py-2 md:py-0">

 ...
 */
?>
<div class="flex flex-col gap-2 <?php print implode(' ', $classes); ?>"<?php print backdrop_attributes($attributes); ?>>

<?php print render($title_prefix); ?>
<?php if ($title): ?>
  <h2 class="block-title w-48 mb-1  pb-3 text-xl font-bold text-[#4b5563] dark:text-[#f9f9f9]">
